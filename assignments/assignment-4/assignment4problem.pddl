(define (problem route-multiple-requests)(:domain openrouter-routing)
  ...
  (:init
    (request_budget req1 low)
    (request_budget req2 mid)
    (request_budget req3 high)
    (request_budget req4 mid)
    (request_budget req5 high)
    
    (budget_cost low cheap)
    (budget_cost mid cheap) ;even if I have a mid budget, I can accept cheap models
    (budget_cost mid moderate)
    (budget_cost high cheap)
    (budget_cost high moderate)
    (budget_cost high expensive)
